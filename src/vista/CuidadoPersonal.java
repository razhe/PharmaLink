...
public class CuidadoPersonal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        if (JTCuidadoPersonal.getColumnModel().getColumnCount() > 0) {
            JTCuidadoPersonal.getColumnModel().getColumn(0).setHeaderValue("codigo");
            JTCuidadoPersonal.getColumnModel().getColumn(1).setHeaderValue("nombre");
            JTCuidadoPersonal.getColumnModel().getColumn(2).setHeaderValue("marca");
            JTCuidadoPersonal.getColumnModel().getColumn(3).setHeaderValue("precio");
            JTCuidadoPersonal.getColumnModel().getColumn(4).setHeaderValue("Fecha de elaboración");
            JTCuidadoPersonal.getColumnModel().getColumn(5).setHeaderValue("Fecha de vencimiento");
            JTCuidadoPersonal.getColumnModel().getColumn(6).setHeaderValue("Dosis");
        }
