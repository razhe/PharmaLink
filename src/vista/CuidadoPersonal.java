 ...
 * @author Eduardo
 */
public class CuidadoPersonal extends javax.swing.JFrame {
    
    /**
     * Creates new form CuidadoPersonal
     */
    ...
    private void initComponents() {
        ...
        BTListarProdCuidado = new javax.swing.JButton();
        jScrollPane1 = new javax.swing.JScrollPane();
        JTCuidadoPersonal = new javax.swing.JTable();
        ...
        BTListarProdCuidado.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes_2/recargar2.png"))); // NOI18N
        BTListarProdCuidado.setBorder(null);
        BTListarProdCuidado.setBorderPainted(false);
        BTListarProdCuidado.setContentAreaFilled(false);
        BTListarProdCuidado.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BTListarProdCuidadoActionPerformed(evt);
            }
        });
        jPanel1.add(BTListarProdCuidado, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, 120, 30));

        JTCuidadoPersonal.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "codigo", "nombre", "marca", "precio", "Fecha de elaboración", "Fecha de vencimiento", "Dosis", "foto"
            }
        ) {
        ...
        JTCuidadoPersonal.setSelectionBackground(new java.awt.Color(195, 204, 204));
        JTCuidadoPersonal.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                JTCuidadoPersonalMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(JTCuidadoPersonal);
        if (JTCuidadoPersonal.getColumnModel().getColumnCount() > 0) {
            JTCuidadoPersonal.getColumnModel().getColumn(0).setResizable(false);
            JTCuidadoPersonal.getColumnModel().getColumn(1).setResizable(false);
            JTCuidadoPersonal.getColumnModel().getColumn(2).setResizable(false);
            JTCuidadoPersonal.getColumnModel().getColumn(3).setResizable(false);
            JTCuidadoPersonal.getColumnModel().getColumn(4).setResizable(false);
            JTCuidadoPersonal.getColumnModel().getColumn(5).setResizable(false);
            JTCuidadoPersonal.getColumnModel().getColumn(6).setResizable(false);
        }

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 65, 1199, 490));

        jSeparator1.setBackground(new java.awt.Color(204, 204, 204));
        jSeparator1.setForeground(new java.awt.Color(204, 204, 204));
        jPanel1.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 50, 120, 10));
    ...
    private void JTCuidadoPersonalMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JTCuidadoPersonalMouseClicked
        // TODO add your handling code here:
        InformacionProducto vistaInfProd = new InformacionProducto();
        
        int rowIndex = JTCuidadoPersonal.getSelectedRow();
        int selectedRow = JTCuidadoPersonal.getSelectedRow();
        
        TableModel tm = JTCuidadoPersonal.getModel();
    ...
    public javax.swing.JButton BTListarProdCuidado;
    ...
    public javax.swing.JTable JTCuidadoPersonal;
