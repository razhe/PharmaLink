...
public class Medicamentos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jBMeds = new javax.swing.JButton();
        ...
        if (jTMedicamentos.getColumnModel().getColumnCount() > 0) {
            ...
            jTMedicamentos.getColumnModel().getColumn(4).setResizable(false);
            jTMedicamentos.getColumnModel().getColumn(5).setResizable(false);
            jTMedicamentos.getColumnModel().getColumn(6).setResizable(false);
        }

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 60, 1199, 490));

        jBMeds.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes_2/recargar2.png"))); // NOI18N
        jBMeds.setBorder(null);
        jBMeds.setBorderPainted(false);
        jBMeds.setContentAreaFilled(false);
        jPanel1.add(jBMeds, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, 120, 30));
    ...
    private void jTMedicamentosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTMedicamentosMouseClicked
        ...
        int rowIndex = jTMedicamentos.getSelectedRow();
        int selectedRow = jTMedicamentos.getSelectedRow();
        
        TableModel tm = jTMedicamentos.getModel();
    ...
    public javax.swing.JTable jTMedicamentos;
